  ...
  const items = [
    {
      ...
      icon: <GroupIcon sx={{ color: '#64b5f6' }} />
    },
    {
    ...
    <Box sx={{ width: '98%', maxWidth: 700, mx: 'auto' }}>
      ...
      >
        ...
        <Box sx={{
          ...
          >
            <span style={{ color: '#64b5f6' }}>MISSION:</span> Unser gemeinsamer Verhaltenskodex für eine sichere und respektvolle Reise durch die Galaxis.
          </Typography>
        </Box>
        ...
        <Box sx={{ p: { xs: 2, sm: 3 } }}>
          ...
          >
            ...
            miteinander umgehen. Unser Awareness-Code hilft uns, eine sichere und angenehme Atmosphäre für alle zu schaffen.
          </Typography>
