            ...
            >
                <Box sx={{ px: 2, pb: 2 }}>
                    ...
                    <ul>
                        ...
                        <li>Behringer XR18 Wireless Mixer</li>
                        <li>Standard Mikrofone (SM58 o.ä.)</li>
                    </ul>

                    <Typography variant="body2" color="text.secondary" sx={{ mt: 2 }}>
                        Bitte beachte: Spezielle Ausrüstung muss selbst mitgebracht werden oder im Vorfeld abgestimmt werden.
                    </Typography>
                </Box>
            </FormCard>
        </SpacePanelLayout>
