...
const FinancialsOverviewPage: React.FC = () => {
  ...
  const calculateTotalsByCategory = () => {
    ...
    return { ticketTotals, beverageTotals, foodTotals, grandTotal };
  };

  const { ticketTotals, beverageTotals, foodTotals, grandTotal } = calculateTotalsByCategory();
                ...
                <Table size="small">
                  ...
                  <TableBody>
                    ...
                    <TableRow sx={{ '& td': { fontWeight: 'bold' } }}>
                      ...
                      <TableCell align="right">{Object.values(ticketTotals).reduce((sum, { count }) => sum + count, 0)}</TableCell>
                      <TableCell align="right">{Object.values(ticketTotals).reduce((sum, { total }) => sum + total, 0).toFixed(2)}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
                ...
                <Table size="small">
                  ...
                  <TableBody>
                    ...
                    <TableRow sx={{ '& td': { fontWeight: 'bold' } }}>
                      ...
                      <TableCell align="right">{Object.values(beverageTotals).reduce((sum, { count }) => sum + count, 0)}</TableCell>
                      <TableCell align="right">{Object.values(beverageTotals).reduce((sum, { total }) => sum + total, 0).toFixed(2)}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
                ...
                <Table size="small">
                  ...
                  <TableBody>
                    ...
                    <TableRow sx={{ '& td': { fontWeight: 'bold' } }}>
                      ...
                      <TableCell align="right">{Object.values(foodTotals).reduce((sum, { count }) => sum + count, 0)}</TableCell>
                      <TableCell align="right">{Object.values(foodTotals).reduce((sum, { total }) => sum + total, 0).toFixed(2)}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
