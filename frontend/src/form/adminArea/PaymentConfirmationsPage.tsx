// Path: frontend/src/form/adminArea/PaymentConfirmationsPage.tsx
...
const PaymentConfirmationsPage: React.FC = () => {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      await axios.put(`/api/booking/${editedBooking.id}/payment`, {
        is_paid: editedBooking.is_paid,
          ...
          {editedBooking && (
            <>
              ...
              <Typography variant="body2" color="text.secondary" gutterBottom>
                {getTicketTitle(editedBooking.ticket_id)} - Expected: €{editedBooking.total_price.toFixed(2)}
              </Typography>
